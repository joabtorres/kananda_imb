...
if (document.getElementById("fotos")) {
    ...
    add_imagem = function () {
        ...
        if (fotos.length > 0) {
            ...
            img.setAttribute("src", "../../assets/painel_admin/imagens/apartamento.jpg");
