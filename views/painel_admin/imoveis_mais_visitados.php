    ...
    <section class="container-fluid">
        <div class="row">
            <header class="col-md-12" id="container-breadcrumb">
                <h1 class="page-header">Imóveis mais Visitados</h1>
                <ol class="breadcrumb">
            ...
            <div id="container-imoveis">
                ...
                if (count($imoveis) > 0) :
                    ...
                    <div class="col-xs-12">
                        <ul class="pagination">
                            <?php
                            echo "<li><a href='" . BASE_URL . "/painel_admin/imoveis/mais_visitados/1'>&laquo;</a></li>";
                            for ($p = 0; $p <= $paginas; $p++) {
                                if ($pagina_atual == ($p + 1)) {
                                    echo "<li class='active'><a href='" . BASE_URL . "/painel_admin/imoveis/mais_visitados/" . ($p + 1) . "'>" . ($p + 1) . "</a></li>";
                                } else {
                                    echo "<li><a href='" . BASE_URL . "/painel_admin/imoveis/mais_visitados/" . ($p + 1) . "'>" . ($p + 1) . "</a></li>";
                                }
                            }

                            echo "<li><a href='" . BASE_URL . "/painel_admin/imoveis/mais_visitados/" . ceil($paginas) . "'>&raquo;</a></li>";
                            ?>
                        </ul>
                    </div>  
                    <?php
