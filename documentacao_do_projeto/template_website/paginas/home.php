        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img data-src="holder.js/100px440" class="img-responsive" alt="...">
                </div>
                <div class="item ">
                    <img data-src="holder.js/100px440" class="img-responsive" alt="...">
                </div>
        ...
        <div class="thumbnail">
            <div class="dest-img">
                <a data-toggle="modal" data-target=".bs-casa-modal">
                    <img data-src="holder.js/300x170" class="img-responsive" alt=""> 
        ...
        <div class="thumbnail">
            ...
            <div class="caption">
                <ul class="list-unstyled">
                    ...
                    <li><hr></li>
                    <li><a href="/imovel/225">Consulta imóvel<span class="ic-mais float-right">+</span></a></li>
                </ul>
            </div>
        </div>
    </article><!-- FIM IMOVEL -->
